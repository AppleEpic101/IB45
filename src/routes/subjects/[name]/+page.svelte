	...
	<div>
		{#if syllabus.name !== 'Creativity, Activity, Service'}
			...
			<div class="grade">
				...
				<p class="p">
					NOTE: As a general trend, Timezone 2 usually have higher grade boundaries than Timezone 1.
					Make sure you use the correct timezone.
				</p>
				<p class="p">
					NOTE: As a general trend, November grade boundaries tend to be higher than those for May.
