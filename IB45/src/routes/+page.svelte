	...
	<div class="intro">
		...
		<div in:fly={{ delay: 400, duration: 1000, y: 100 }}>
			<p class="main">
				...
				IB grades. Its importance is particularly evident in the context of university applications,
				where predicted grades play a pivotal role. By utilizing official grade boundaries data from
				past IB exam sessions, the calculator ensures a high level of precision in its grade
				predictions. This accuracy provides students with a clearer understanding of their potential
				outcomes, aiding their university aspirations and decisions.
			</p>

			<p class="main">
				The incorporation of historical grade boundaries lends credibility to the predictions,
				offering students a reliable source of information to gauge their performance. In essence,
				the calculator empowers students to plan ahead and make well-informed choices based on their
				predicted IB grades, which can significantly impact their higher education opportunities.
			</p>

			<p class="main">
				Introducing our latest enhancement to IB Predict! We're thrilled to introduce a brand new
				feature that enables students to accurately predict their grades for individual subjects.
				Try it out <a href="/subjects">here.</a>
			</p>
			<p>
				<strong>
