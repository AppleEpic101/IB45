...
<div class="intro">
	...
	<div in:fly={{ delay: 400, duration: 1000, y: 100 }}>
		<p class="main">
			...
			grades. Its importance is particularly evident in the context of university applications,
		...
		<p class="main">
			...
			offering students a reliable source of information to gauge their performance. In essence, the
			calculator empowers students to plan ahead and make well-informed choices based on their
		...
		<p class="main">
			...
			feature that enables students to accurately predict their grades for individual subjects. Try
			it out <a href="/subjects">here.</a>
		</p>
		<p>
			<strong>
